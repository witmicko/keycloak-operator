...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClientPair) DeepCopyInto(out *ClientPair) {
	*out = *in
	if in.KcClient != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClientPair.
func (in *ClientPair) DeepCopy() *ClientPair {
	if in == nil {
		return nil
	}
	out := new(ClientPair)
